...
const _SOUND_EXTENSION = {"aac":null,"aif":null,"aiff":null,"amr":null,"ape":null,"au":null,"awb":null,"caf":null,"dct":null,"dss":null,"dvf":null,"flac":null,"gsm":null,"iklax":null,"ivs":null,"m4a":null,"m4b":null,"m4p":null,"mmf":null,"mp3":null,"mpc":null,"msv":null,"oga":null,"ogg":null,"opus":null,"ra":null,"ram":null,"raw":null,"rf64":null,"sln":null,"tta":null,"voc":null,"vox":null,"wav":null,"wma":null,"wv":null}
## 是否是音频文件
static func is_audio(path: String) -> bool:
	return _SOUND_EXTENSION.has(path.get_extension().to_lower()) 

const _VIDEO_EXTENSION = {"3g2":null,"3gp":null,"3gp2":null,"3gpp":null,"amv":null,"asf":null,"avi":null,"avs":null,"bik":null,"bin":null,"bix":null,"bmk":null,"divx":null,"drc":null,"dv":null,"evo":null,"f4v":null,"flv":null,"gvi":null,"gxf":null,"iso":null,"m1v":null,"m2t":null,"m2ts":null,"m2v":null,"m4v":null,"mkv":null,"mov":null,"mp2":null,"mp2v":null,"mp4":null,"mp4v":null,"mpe":null,"mpeg":null,"mpeg1":null,"mpeg2":null,"mpeg4":null,"mpg":null,"mpv2":null,"mts":null,"mtv":null,"mxf":null,"mxg":null,"nsv":null,"nuv":null,"ogg":null,"ogm":null,"ogv":null,"ps":null,"rec":null,"rm":null,"rmvb":null,"rpl":null,"thp":null,"tod":null,"ts":null,"tts":null,"txd":null,"vob":null,"vp3":null,"vp6":null,"vro":null,"webm":null,"wm":null,"wmv":null,"wtv":null,"xesc":null}
## 是否是视频文件
static func is_video(path: String) -> bool:
	return _VIDEO_EXTENSION.has(path.get_extension().to_lower())

const _IMAGE_EXTENSION = {"bmp":null,"gif":null,"jpeg":null,"jpg":null,"png":null,"psd":null,"svg":null,"tif":null,"tiff":null,"webp":null,"raw":null}
## 是否是图片类型后缀名
static func is_image_suffix(path: String) -> bool:
	return _IMAGE_EXTENSION.has(path.get_extension().to_lower())
...
static func is_text_file(path: String) -> bool:
	...
	if file:
		...
		if file.get_length() >= LENGTH:
			return bytes.get_string_from_ascii().length() == LENGTH
		else:
